...
export const TATENDA_INSTRUCTIONS = [
  ...
  "",
  "PDF GENERATION:",
  "When you generate a PDF using the generatePDF tool:",
  "1. DO NOT include download links or URLs in your response",
  "2. Simply acknowledge that the PDF has been created (e.g., 'I've generated the PDF for you')",
  "3. The system will automatically display a download card with the file",
  "4. Keep your message brief and informative about what was created",
  "",
